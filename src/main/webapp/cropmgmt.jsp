...
%>
  ...
  <title>Crop Management - Agenculture</title>
...
%>
  ...
  <section class="hero-section">
    <h1>Crop Management: Enhance Productivity</h1>
    <p>Discover advanced crop management techniques to maximize your agricultural productivity, reduce risks, and boost your farm's efficiency.</p>
  </section>

  <!-- Main Content Section -->
  <section class="container my-5">
    <h2 class="text-center mb-4">Effective Crop Management Strategies</h2>
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <img src="planning.png" class="card-img-top" alt="Crop Planning" style="height: 250px;">
          <div class="card-body">
            <h5 class="card-title">Crop Planning</h5>
            <p class="card-text">Proper planning is key to achieving optimal yields. Learn about crop rotation, timely sowing, and choosing the right crop variety for your soil and climate.</p>
      ...
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <img src="ferti.jpeg" class="card-img-top" alt="Irrigation and Fertilization" style="height: 250px;">
          <div class="card-body">
            <h5 class="card-title">Irrigation & Fertilization</h5>
            <p class="card-text">Optimize irrigation and fertilization techniques to ensure your crops receive the right amount of nutrients and water at the right time.</p>
    ...
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <img src="orangic-pest-control.jpg" class="card-img-top" alt="Pest and Disease Control" style="height: 250px;">
          <div class="card-body">
            <h5 class="card-title">Pest & Disease Control</h5>
            <p class="card-text">Learn about integrated pest management (IPM) practices and how to effectively control pests and diseases using eco-friendly methods.</p>
      ...
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <img src="post.jpg" class="card-img-top" alt="Harvesting and Post-Harvest Management" style="height: 250px;">
          <div class="card-body">
            <h5 class="card-title">Harvesting & Post-Harvest</h5>
            <p class="card-text">Get the most out of your crops by learning proper harvesting techniques and how to store crops to prevent spoilage.</p>
  ...
  <section class="container my-5 text-center">
    ...
    <p>If you're looking to enhance your crop management strategies, get in touch with us for a consultation or workshop!</p>
    <p><strong>📞 Call us at:</strong> +91-123-456-7890</p>
    <p><strong>📧 Email us at:</strong> Agenculture@2024.com</p>
    <a href="contactpage.jsp" class="btn btn-success">Schedule a Consultation</a>
  </section>
