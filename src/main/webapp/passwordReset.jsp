...
<body>
 ...
 <div class="out-container">  
    ...
    <br><br><br><form action="ForgotPassword" method="post" name="userForm" class="needs-validation container-fluid align-center mx-auto p-2 border border-radius shadow p-3 mb-5 bg-body-primary rounded padding 30px" novalidate onsubmit="return validateForm();">
    <div class="container-fluid">
        <p class="h1 text-center">Password Reset</p>
      </div>
  ...
  <%}else{ %>
  <input type="hidden" value="<%= session.getAttribute("uname")%>"name="mail">
  <%} %>
  <div class="mb-3">
  ...
  <div class="mb-3">
   ...
   <div class="mb-3">
    ...
    <input type="text" class="form-control" name="nick" placeholder="What is Your Nick Name(Security Question)" required>
