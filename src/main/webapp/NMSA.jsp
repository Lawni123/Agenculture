...
%>
    ...
    <title>National Mission on Sustainable Agriculture (NMSA)</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="hero-section">
        <h1>National Mission on Sustainable Agriculture (NMSA)</h1>
        <p>The National Mission on Sustainable Agriculture (NMSA) is a key initiative by the Government of India aimed at promoting sustainable agricultural practices to ensure food security and improve the livelihoods of farmers. 
       <br> <a href="https://nmsa.dac.gov.in/" class="btn btn-custom">Know More</a>
      </div>

     
     <br><br>
      
      <h3>Key Features of NMSA:</h3>
      <ul>
        <li><strong>Soil Health Management:</strong> NMSA focuses on improving soil health through the use of organic fertilizers and practices like crop rotation, intercropping, and green manure.</li>
        <li><strong>Water Use Efficiency:</strong> The mission emphasizes efficient water management through rainwater harvesting, water conservation techniques, and the promotion of micro-irrigation systems.</li>
        <li><strong>Climate Resilience:</strong> NMSA aims to help farmers adapt to climate change by promoting drought-resistant crops, efficient water management, and agro-climatic zoning.</li>
        <li><strong>Capacity Building:</strong> The mission provides training and support to farmers on sustainable agricultural practices, pest management, and organic farming techniques.</li>
      </ul>
      
     
      <h3>Objectives of NMSA:</h3>
      <ul>
        <li>To promote sustainable agricultural practices that improve productivity and soil health.</li>
        <li>To enhance water use efficiency and promote efficient irrigation systems.</li>
        <li>To reduce the adverse impacts of climate change on agriculture.</li>
        <li>To increase the adoption of organic farming and eco-friendly agricultural practices.</li>
      </ul>
      
      <h3>Benefits of NMSA:</h3>
      <ul>
        <li><strong>Improved Soil Health:</strong> Sustainable farming practices help improve soil fertility and structure, ensuring long-term agricultural productivity.</li>
        <li><strong>Efficient Water Use:</strong> Water conservation and management techniques lead to better use of available water resources.</li>
        <li><strong>Higher Agricultural Productivity:</strong> By promoting sustainable farming, the mission aims to boost agricultural yields while maintaining environmental health.</li>
        <li><strong>Climate Resilience:</strong> NMSA promotes climate-resilient crops, helping farmers adapt to changing weather patterns and reduce crop failure risks.</li>
      </ul>
    </div>
      ...
      <div class="container text-center text-md-left">
        <div class="row">
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>We are committed to providing sustainable agricultural solutions and promoting practices that are both environmentally friendly and economically viable for farmers.</p>
          </div>
