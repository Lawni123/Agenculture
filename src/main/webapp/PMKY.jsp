  ...
  <body>
    ...
    <div class="container">
      <div class="hero-section">
        <h1>PARAMPRAGAT KRISHI VIKAS YOJANA</h1>
       <p> Paramparagat Krishi Vikas Yojana (PKVY) is a flagship scheme of the Government of India aimed at promoting organic farming in the country. It focuses on supporting and encouraging farmers to adopt eco-friendly and sustainable agricultural practices.
       </p> <a href="https://www.myscheme.gov.in/schemes/pkvy" class="btn btn-custom">Know More</a>
      </div>

      <br><br>
   
      <h3>Key Features of PKVY:</h3>
      <ul>
        <li><strong>Cluster Approach:</strong> The scheme promotes organic farming through a cluster approach, where groups of farmers are encouraged to form clusters for collective action.</li>
        <li><strong>Participatory Guarantee System (PGS):</strong> PKVY emphasizes the use of PGS for organic certification, a system that relies on trust and social networks within the farming community.</li>
        <li><strong>Financial Assistance:</strong> Farmers receive financial assistance for inputs like bio-fertilizers, bio-pesticides, and organic manure.</li>
        <li><strong>Capacity Building:</strong> The scheme provides training and capacity-building programs for farmers on organic farming techniques, market linkages, and value addition.</li>
      </ul>
      
      
      <h3>Objectives of PKVY:</h3>
      <ul>
        <li>To promote commercial organic production through certified organic farming.</li>
        <li>To produce pesticide-free agricultural products.</li>
        <li>To improve soil health and enhance farmer incomes.</li>
        <li>To create a market for organic products.</li>
      </ul>
      
      <h3>Benefits of PKVY:</h3>
      <ul>
        <li><strong>Improved soil health:</strong> Organic farming practices enhance soil fertility and biodiversity.</li>
        <li><strong>Reduced environmental impact:</strong> Organic farming minimizes the use of harmful chemicals, reducing pollution and protecting the environment.</li>
        <li><strong>Enhanced farmer incomes:</strong> Organic products often fetch higher prices in the market, leading to increased income for farmers.</li>
        <li><strong>Improved food quality:</strong> Organic farming produces healthier and more nutritious food for consumers.</li>
      </ul>
    </div>
