			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link"
						href="generalinfo.jsp">General Info</a></li>
...
<body>
	...
	<section class="hero-section">
		<h1>Our Products</h1>
		<p>
			"Explore our wide range of organic agriculture products, cultivated
			with care and sustainability at heart. <br> From farm-fresh
			vegetables and grains to eco-friendly solutions, our products are
			designed to nourish your family and the planet. <br> Embrace the
			purity of nature with every choice, ensuring health and harmony for
			generations to come."
		</p>
		...
		<a href="addProducts.jsp"><button class="btn btn-success "
				type="button" aria-expanded="false">Add Products</button></a> <a
			href="addEquipment.jsp"><button class="btn btn-success "
				type="button" aria-expanded="false">Add Equipment</button></a>
	...
	<br>
	<div class="col">
		<div class="card h-75 text-center" style="border-color: white;">
			<a href="Fruits"><img src="fruit1.jpg"
				class="card-img-top mx-auto d-block" alt="Product 1"
				style="width: 850px; height: auto;"></a>
			<div class="card-body">
				<h2 class="card-title">
					Organic Fruits
					</h5>
					<p class="card-text">
						"Fresh, juicy, and naturally grown! Our organic fruits are packed
						with nutrients, <br> free from harmful chemicals, and
						bursting with flavor. Experience the goodness of nature in every
						bite <br>– the perfect choice for a healthy lifestyle!"
					</p>
			</div>
		</div>
	</div>
	...
	<div class="col">
		<div class="card h-75 text-center" style="border-color: white;">
			<a href="Vegetables"><img src="vegetables.jpg"
				class="card-img-top mx-auto d-block" alt="Product 1"
				style="width: 850px; height: auto;"></a>
			<div class="card-body">
				<h2 class="card-title">
					...
					<p class="card-text">
						"Fresh, flavorful, and grown with care—organic vegetables are
						nature's finest gift to your plate. <br> Free from chemicals
						and packed with nutrients, they promote a healthier lifestyle
						while supporting sustainable farming. <br> Choose organic,
						choose health!"
					</p>
			</div>
		</div>
	...
	<div class="col">
		<div class="card h-75 text-center" style="border-color: white;">
			<a href="Grains"><img src="grainy.jpg"
				class="card-img-top mx-auto d-block" alt="Product 1"
				style="width: 850px; height: auto;"></a>
			<div class="card-body">
				<h2 class="card-title">
					...
					<p class="card-text">
						"Discover the purity of nature with our organic grains—grown
						without chemicals, <br> rich in nutrients, and full of
						flavor. Perfect for a healthy lifestyle, our grains support
						sustainable <br>farming and your well-being. Choose natural,
						choose organic!"
					</p>
			</div>
		</div>
	...
	<div class="col">
		<div class="card h-75 text-center" style="border-color: white;">
			<a href="FetchEquipment"><img src="Equipment1.jpeg"
				class="card-img-top mx-auto d-block" alt="Product 1"
				style="width: 850px; height: auto;"></a>
			<div class="card-body">
				<h2 class="card-title">
					...
					<p class="card-text"><p class="card-text">
						"Discover the purity of nature with our organic grains—grown
						without chemicals, <br> rich in nutrients,  and full of flavor. Perfect for a healthy lifestyle,  our grains support sustainable  <br>farming and your well-being. Choose natural, choose organic!"</p>
 </p>
      ...
      <div class="container text-center text-md-left">
        <div class="row">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
						<a href="#" class="text-white text-decoration-none">Organic Vegetables</a>
					</p>
            <p>
            ...
            <p>
						<a href="#" class="text-white text-decoration-none">Farming Tools</a>
					</p>
          </div>
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
						<a href="#" class="text-white text-decoration-none">Soil Testing</a>
					</p>
            <p>
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
						<i class="fas fa-home mr-3"></i> 123 Green Lane, Organic Town, USA</p>
            <p>
						<i class="fas fa-envelope mr-3"></i> info@agroweb.com</p>
            <p>
						<i class="fas fa-phone mr-3"></i> +1 234 567 890</p>
            <p>
