...
<body>
 ...
 <div class="out-container">  
    ...
    <br><br><br><form action="AddEquipment" method="post" name="userForm" class="needs-validation container-fluid align-center mx-auto p-2 border border-radius shadow p-3 mb-5 bg-body-primary rounded padding 30px" enctype="multipart/form-data" onsubmit="return validateForm();"novalidate >
    <div class="container-fluid">
        <p class="h1 text-center">Add Equipment</p>
      </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="info" placeholder="Enter Equipment Discription" required>
  </div>
  <div class="mb-3">
    <label for="validationPassword" class="form-label">Price Per Hour</label>
    <input type="text" class="form-control" name="price" placeholder="Enter Price Per Hour" required>
  </div>
  
  <div class="mb-3">
    <label for="validationPassword" class="form-label">No Of Equipment</label>
    <input type="text" class="form-control" name="number" placeholder="Enter No Of Equipment" required>
  </div>
  <div class="mb-3">
