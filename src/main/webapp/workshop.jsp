...
%>
      ...
      <section class="hero-section">
        <h1>Explore Our Agriculture Workshops</h1>
        <p>Learn, innovate, and grow with sustainable farming practices.</p>
         <%
    if(session.getAttribute("name") != null && session.getAttribute("name").equals("Admin")) {
%>
                     <button type="button" class="btn btn-success">Registered Customers</button>
                        <%
    }
%>
      </section>
 ...
 <body>
    ...
    <div class="container py-5">
        <h2 class="text-center mb-4">Upcoming Workshops <br>
                                 
       </h2>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card">
                    <img src="woman-holding-flower-pot-medium-shot.jpg" class="card-img-top" alt="Workshop 1">
                    <div class="card-body">
                        <h5 class="card-title">Organic Farming Techniques</h5>
                        <p class="card-text">Learn sustainable organic farming methods from experts.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="young-woman-controlling-plantation.jpg" class="card-img-top" alt="Workshop 2">
                    <div class="card-body">
                        <h5 class="card-title">Smart Farming with IoT</h5>
                        <p class="card-text">Explore how IoT technology can revolutionize agriculture.</p>
                        <button class="btn btn-success w-100">Register Now</button>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <img src="beautiful-woman-summer-field.jpg" class="card-img-top" alt="Workshop 3">
                    <div class="card-body">
                        <h5 class="card-title">Sustainable Irrigation</h5>
                        <p class="card-text">Master efficient water management techniques,which is very helpful.</p>
                        <button class="btn btn-success w-100">Register Now</button>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-light py-5">
        <div class="container">
            <h2 class="text-center mb-4">Workshop Timeline</h2>
            <div class="timeline">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="border p-4 bg-white shadow-sm">
                            <h5>Day 1: Introduction to Organic Farming</h5>
                            <p>Understand the principles of organic farming and soil management.</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="border p-4 bg-white shadow-sm">
                            <h5>Day 2: Crop Management</h5>
                            <p>Learn crop rotation, pest control, and nutrient management techniques.</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="border p-4 bg-white shadow-sm">
                            <h5>Day 3: Technology in Agriculture</h5>
                            <p>Discover how to use modern tools like drones and smart sensors.</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="border p-4 bg-white shadow-sm">
                            <h5>Day 4: Practical Sessions</h5>
                            <p>Hands-on practice with expert supervision.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container py-5">
        <h2 class="text-center mb-4">What Our Participants Say</h2>
        <div class="row g-4">
            <div class="col-md-6">
                <blockquote class="blockquote p-4 bg-light border rounded">
                    <p>"The workshops helped me transform my small farm into a thriving organic business."</p>
                    <footer class="blockquote-footer">Jane Doe</footer>
                </blockquote>
            </div>
            <div class="col-md-6">
                <blockquote class="blockquote p-4 bg-light border rounded">
                    <p>"I loved the practical sessions. The experts were very approachable and helpful."</p>
