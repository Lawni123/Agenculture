...
<%@ page import="com.Agriculture.OBJ.Message"%>
<!doctype html>
<html lang="en">
<head>
<%
...
<body>
	...
	<section class="contact-header">
		<div
			style="height: 280px; background: linear-gradient(120deg, #0cab51, #1bc55f); color: white; display: flex; flex-direction: column; justify-content: center; align-items: center;">
			<br> <br> <br>
			<h1 style="text-align: center;">Contact Us</h1>
			<p style="text-align: center;">We’d love to hear from you! Feel
				free to reach out for any questions or feedback.</p>
			<%
			if (session.getAttribute("name") != null && !session.getAttribute("name").equals("Admin")) {
			%>
			<a href="GetMessage"><button type="button" class="btn btn-success">Inbox</button></a>
			<%
			}
			%>
			<br> <br>
    ...
    <h2 class="text-center mb-4">Admin Inbox</h2>
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#messageModal<%=message.getId()%>">Read More</button>
                </td>
            </tr>

            <!-- Bootstrap Modal for Read More -->
            <div class="modal fade" id="messageModal<%=message.getId()%>" tabindex="-1" aria-labelledby="messageModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><strong>Name:</strong> <%=message.getSender()%></p>
                            <p><strong>Email:</strong> <%=message.getMail()%></p>
                            <p><strong>Subject:</strong> <%=message.getSubject()%></p>
                            <p><strong>Message:</strong> <%=message.getMessage()%></p>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#replyModal<%=message.getId()%>">Reply</button>
            ...
            <!-- Reply Modal -->
            <div class="modal fade" id="replyModal<%=message.getId()%>" tabindex="-1" aria-labelledby="replyModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form method="post" action="SendMessage">
                                <input type="hidden" name="sid" value="<%=message.getSid()%>">
		...
		<div class="row g-4">
			...
			<div class="col-md-4">
				<div class="contact-info p-4 shadow-sm">
					...
					<p>
						<strong>Phone:</strong> +917483772801
					</p>
					<p>
						<strong>Email:</strong> anuroopsimpi2@gmail.com
					</p>
					<p>
						<strong>Address:</strong> Kalaburgi,karnataka,India
					</p>
					<p>
			...
			<div class="col-md-8">
				<form class="p-4 shadow-sm" method="post" action="SendMessage">
