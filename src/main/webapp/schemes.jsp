...
%>
  ...
  <body>
        ...
        <div style="height: 300px; background: linear-gradient(120deg, #0cab51, #1bc55f);"><header class="bg text-white text-center py-4">
            <br><br><br><br><h1>Organic Farming Schemes</h1>
            <p>Explore government initiatives and benefits for organic farming</p>
        </header></div>
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="ancient1.jpg" class="card-img-top" alt="Scheme Image" style="height: 300px">
                        <div class="card-body">
                            <h5 class="card-title">Paramparagat Krishi Vikas Yojana <br> (PKVY)</h5>
                            <p class="card-text">Promotes cluster-based organic farming and provides financial assistance for certification and training.</p>
                            <a href="PMKY.jsp" class="btn btn-success">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="main3.jpg" class="card-img-top" alt="Scheme Image" style="height: 300px;">
                        <div class="card-body">
                            <h5 class="card-title">National Mission on Sustainable Agriculture (NMSA)</h5>
                            <p class="card-text">Supports soil health management, capacity building, and organic input supply for farmers.</p>
                            <a href="NMSA.jsp" class="btn btn-success">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="agritech.jpg" class="card-img-top" alt="Scheme Image" style="height: 300px;">
                        <div class="card-body">
                            <h5 class="card-title">Rashtriya Krishi Vikas Yojana <br> (RKVY)</h5>
                            <p class="card-text">Focuses on organic farming projects, infrastructure development, and innovation for farmers.</p>
                            <a href="RKVY.jsp" class="btn btn-success">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card">
                        <img src="marketaccess.jpg" class="card-img-top" alt="Scheme Image" style="height: 300px;">
                        <div class="card-body">
                            <h5 class="card-title">Organic Certification Assistance</h5>
                            <p class="card-text">Financial aid for organic certification processes under government-approved programs.</p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="fund.jpeg" class="card-img-top" alt="Scheme Image" style="height: 300px;">
                        <div class="card-body">
                            <h5 class="card-title">Agri-Tech Infrastructure Fund</h5>
                            <p class="card-text">Provides financial assistance for modernizing agricultural infrastructure, including organic farming.</p>
                            <a href="NMSA.jsp" class="btn btn-success">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="afford.jpg" class="card-img-top" alt="Scheme Image" style="height: 300px;">
                        <div class="card-body">
                            <h5 class="card-title">Subsidy on Organic Inputs</h5>
                            <p class="card-text">Subsidies on bio-fertilizers, vermicompost, and organic pesticides to encourage organic farming.</p>
                            <a href="#" class="btn btn-success">Learn More</a>
                        </div>
                    </div>
                </div>
