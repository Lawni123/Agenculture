...
function showQuantityForm2(button, productName) {
    var formContainer = button.closest('.card-body').querySelector('.quantity-form-container1');
						...
						<div class="col-md-6">
							<div class="card-body p-1 mt-3">
								...
								%>
                                  ...
                                  <button onclick="showQuantityForm2(this, '<%=product.getName()%>')" class="btn btn-success">Book Now</button>  
									 
									 <div class="quantity-form-container1 mt-3" style="display:none;">
                                    <form action="Order" method="post">
                                        <input type="hidden" name="prodId" value="<%=product.getId()%>">
                                        <input type="hidden" name="price" value="<%=product.getPrice()%>">
                                        <input type="hidden" name="prodName" value="<%=product.getName()%>">
                                        <input type="number" name="qty" class="form-control mb-2" placeholder="Enter Hours" min="1" required>
