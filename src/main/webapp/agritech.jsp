...
%>
  ...
  <title>Agri-Tech | Agenculture</title>
...
<body>
  ...
  <section class="hero-section">
    <h1>Agri-Tech: Revolutionizing Farming with IoT, Drones, and AI</h1>
    <p>Discover the role of Internet of Things (IoT), drones, and artificial intelligence (AI) in transforming the agricultural industry. From smart sensors to precision farming techniques, we bring cutting-edge technology to the fields.</p>
  </section>

  <section class="container my-5">
    <h2 class="text-center mb-4">Agri-Tech Innovations</h2>
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="card h-100">
          <img src="iot4.jpg" class="card-img-top" alt="IoT in Agriculture">
          <div class="card-body">
            <h5 class="card-title">IoT in Agriculture</h5>
            <p class="card-text">IoT enables farmers to monitor crops and environmental conditions in real time, allowing for data-driven decisions to improve efficiency and productivity.</p>
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100">
          <img src="drone2.jpg" class="card-img-top" alt="Drones in Agriculture">
          <div class="card-body">
            <h5 class="card-title">Drones in Agriculture</h5>
            <p class="card-text">Drones are revolutionizing how farmers survey fields, monitor crop health, and even apply fertilizers, offering unparalleled precision and speed.</p>
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100">
          <img src="AIagro2.jpg" class="card-img-top" alt="AI in Agriculture">
          <div class="card-body">
            <h5 class="card-title">AI in Agriculture</h5>
            <p class="card-text">AI-driven tools analyze farm data to forecast weather, detect diseases, and optimize irrigation, ultimately enhancing crop yields and reducing resource waste.</p>
  ...
  <section class="container my-5 text-center">
    <h2>Get in Touch</h2>
    <p>Interested in learning how Agri-Tech can transform your farming practices?</p>
