...
<div class="h2 text-center">My Orders</div>
</head>
<body class="bg-light">
  <%
            ArrayList<Order> orderList = (ArrayList<Order>) session.getAttribute("orderlist");
           
                Map<Integer, List<String>> orderMap = new LinkedHashMap<>();
                Map<Integer, String> statusMap = new LinkedHashMap<>();
                
                for (Order order : orderList) {
                    orderMap.computeIfAbsent(order.getOrderId(), k -> new ArrayList<>()).add(order.getProdName());
                    statusMap.put(order.getOrderId(), order.getStatus());
                } %>
        ...
        %> 
            ...
            <div class="order-card " >
                ...
                <form method="get" action="TrackOrder">
                    <input type="hidden" name="orderId" value="<%= entry.getKey() %>">
