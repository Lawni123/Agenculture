...
%>
  ...
  <body>
   <div style="background: linear-gradient(120deg, #0cab51, #1bc55f); height: 300px;"> <header class="bg text-white py-5">
        <div class="container text-center">
            <br><br><h1>Welcome to Organic Farming</h1>
            <p class="lead">Promoting sustainable agriculture and healthy living.</p>
        </div>
    </header></div>
    ...
    <main class="container my-5">
        <div class="row">
            <div class="col-md-6">
                <img src="orggeneral.jpg" alt="Organic Farming" class="img-fluid rounded">
            </div>
            <div class="col-md-6">
                <h2>What is Organic Farming?</h2>
                <p>Organic farming is an agricultural system that seeks to produce food while maintaining ecological balance, enhancing soil fertility, and avoiding synthetic chemicals. It focuses on sustainable practices that respect the environment.</p>
                <h3>Key Benefits:</h3>
                <ul>
                    <li>Preserves biodiversity and ecosystem health.</li>
                    <li>Produces healthy, chemical-free food.</li>
                    <li>Enhances soil fertility and water conservation.</li>
                </ul>
            </div>
        </div>
    </main>
    ...
    <section class="bg-light py-5">
        <div class="container">
            <h2 class="text-center mb-4">Why Choose Organic Farming?</h2>
            <div class="row">
                <div class="col-md-4 text-center">
                  <i class="bi bi-globe text-success fs-1 "></i>
                    <h4>Eco-Friendly</h4>
                    <p>Reduces environmental pollution and promotes sustainable agriculture.</p>
                </div>
                <div class="col-md-4 text-center">
                    <i class="bi bi-house-fill text-success fs-1"></i>
                    <h4>Healthy Lifestyle</h4>
                    <p>Offers nutrient-rich and chemical-free produce for a healthier life.</p>
                </div>
                <div class="col-md-4 text-center">
                    <i class="bi bi-heart text-success fs-1"></i>
                    <h4>Sustainable Future</h4>
                    <p>Supports the long-term health of people and the planet.</p>
                </div>
            </div>
        </div>
    </section>
