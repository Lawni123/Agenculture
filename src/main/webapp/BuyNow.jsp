...
<script>
        function showPaymentDetails() {
            ...
            document.getElementById("scannerDetails").style.display = paymentMethod === "Scanner" ? "block" : "none";
        }
    </script>
<style>
    body {
...
%>
    ...
    <div class="container mt-5">
        ...
        <h4>Delivered to : <%= user.getName() %> </h4>
        ...
        <form action="BuyNow" method="POST">
            <div class="mb-3">
                ...
                <select id="paymentMethod" name="paymentMethod" class="form-select" required onchange="showPaymentDetails()">
            ...
            <div id="upiDetails" style="display: none;">
                <h5>UPI ID: 1234567890@upi</h5>
                <label for="transactionId" class="form-label">Transaction ID:</label>
                <input type="text" id="transactionId" name="transactionId" class="form-control" placeholder="Enter Transaction ID">
            </div>

            <!-- Scanner Payment Details -->
            <div id="scannerDetails" style="display: none;">
                <h5>Scan the QR Code</h5>
                <img src="scanner.jpeg" alt="Scanner QR Code" width="200">
              <br> &nbsp;  <label for="scannerTransactionId" class="form-label">Transaction ID:</label>
                <input type="text" id="scannerTransactionId" name="scannerTransactionId" class="form-control" placeholder="Enter Transaction ID">
            </div>
